...
mongoose.connect('mongodb+srv://fawad:4m1nDqawQWap7Mqs@cluster0.7z3ogok.mongodb.net/?retryWrites=true&w=majority');
//app
let app = express();
...
let Auth = async (req, res, Next) => {
  try {
    ...
    await jsonwebtoken.verify(headerToken, 'afuqhfqowfjqidokdpqockv ,avma,mfalfmwofqpofmqfm', (err, user) => {
      if (err) {
...
app.get('/DownloadCv', async (req, res) => {
  try {
    ...
    let filePath = path.resolve('./Fawad Rehman.pdf')
